...
public class RequestUtil {
	 ...
	 * 
	 * @param toSend
	 *            The data to Send at the bank
	 * @param banque
	 *            the bank to Send the data
	 * @param url
	 *            the link of the service to join
	 * @param token
	 *            the token generated by the bank if this is a solde display, a
	 *            virement or a retrait
	 * @return
	 * @throws IOException
	 * @throws JSONException
	 */
	public static String sendRequest(String toSend, Banque banque, String url, String token)
