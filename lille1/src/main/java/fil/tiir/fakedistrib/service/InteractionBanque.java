...
public interface InteractionBanque {
	/**
	 * Service that create an account, contact the bank and create an account A
	 * InteractionBanqueException is Generated when the bank don't respond
	 * 
	 * @param A
	 *            client
	...
	/**
	 * Take the information from the client object and ask the bank if the
	 * Information are correct If the information is correct, the service fill
	 * the client object with the information received
	 * 
	 * @param client
	 * @throws InteractionBanqueException
	 */
	...
	/**
	 * Consume the Token in the client object and Display the sum available in
	 * the Account_Id account
	 * 
	 * @param client
	 * @return
	 * @throws InteractionBanqueException
	...
	/**
	 * Verify if the Distributor has enough cash, if there are enough cash,
	 * Consume the token and retire the Sum from the client account save the
	...
	/**
	 * Consume the token and give the sum from the client Account_id at the
	 * Virement Account_from
	 * 
	 * @param client
	 * @param virement
	 * @throws InteractionBanqueException
